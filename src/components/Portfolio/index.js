    ...
    return (
        <section className="project-container">
            {projects.map(project => (
                <div className={"project " + project.index} key={project.index}>
                    <div className="project-details-container">
                      ...
                      <div className="svg-container">
                        <svg onClick={() => window.open(project.deployedUrl, "_blank")} width="24" height="24" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
